...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      <div class="<?php if ($akses['konsst'] == 'Y'){ echo 'col-lg-10';}?> box-header">
      <h3 class="box-title"><?php echo $tabel ?></h3>
      </div>
      <?php if ($akses['konsst'] == 'Y'): ?>
      <div class="small-box">
        ...
        <div class="table-responsive">
          <table id="dataTables-example" class="table table-bordered table-striped now" >
                    <thead class="text-primary">
                        <th>NO</th>
                        <th>STATUS SERVIS</th>
                        <?php if ($akses['konssu'] == 'Y' OR $akses['konssd'] == 'Y'): ?>
                        <th>ACTION</th>
                        <?php endif ?>
